...
test('pages receive the signed-in user with their position but without sensitive fields', function () {
    $admin = User::factory()->for(Usertype::factory()->create(['type_name' => 'Information Technology Officer']))->admin()->create();
